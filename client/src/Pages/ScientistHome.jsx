...
const ScientistHome = () => {
  ...
  const sendDataForCommunity = async (id) => {
    ...
    try {
      const response = await axios.post("http://localhost:5000/scientist/insert-community-data", {
        uploadedBy: userId,
        communityId: id,
        dataArray: data
        ...
        <div style={{ borderRadius: "2rem 0 0 2rem" }} className='bg-[#f4f7fc] p-6'>
          ...
          <div className="flex gap-6 w-full h-auto">
            <div className="w-[60vw] rounded-lg flex gap-6">
              ...
              <div className='h-full w-1/3 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-900 hover:from-blue-500 hover:to-blue-900 focus:ring-4 focus:ring-blue-300' style={{
            ...
            <div className="w-[40vw] rounded-lg flex flex-col gap-6">
              <div className='grid grid-cols-3 gap-6 h-1/3' >
                ...
                <div className="bg-white rounded-xl p-4 text-white bg-gradient-to-br from-blue-500 to-blue-900 hover:from-blue-500 hover:to-blue-900 focus:ring-4 focus:ring-blue-300" style={{
                  boxShadow: "rgba(0, 0, 0, 0.1) 3px 1px 7px 0px",
...
>
  ...
  <Modal.Header className="bg-gray-800 border-b border-gray-700">
    <h2 className="text-2xl font-bold text-green-500">Select a Community</h2>
  </Modal.Header>
