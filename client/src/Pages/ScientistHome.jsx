...
const ScientistHome = () => {
  ...
  const clearMapLayers = () => {
    ...
    if (map.current.getLayer(heatmapLayerId)) map.current.removeLayer(heatmapLayerId);
    ...
    if (map.current.getSource('cluster-data')) map.current.removeSource('cluster-data');
  };
          ...
          <div className="flex justify-between items-center mb-8">
            ...
            <div className='flex'>
              ...
              <button
                ...
                <button className='relative p-3 rounded-xl text-sm font-medium bg-red-500 text-white' style={{padding: '0 1rem 0 2rem'}}> 

                      <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none" >
                          <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
                              <path stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5v10M3 5a2 2 0 1 0 0-4 2 2 0 0 0 0 4Zm0 10a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm12 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm0 0V6a3 3 0 0 0-3-3H9m1.5-2-2 2 2 2"/>
                          </svg>
                      </div>
                  Customize
                </button>
      ...
      {loading && (
        ...
        <div className='grid grid-cols-4 gap-6 h-1/3 mb-5' >
          ...
          <div className="bg-white rounded-xl p-4 text-white bg-gradient-to-br from-blue-500 to-blue-900 hover:from-blue-500 hover:to-blue-900 focus:ring-4 focus:ring-blue-300" style={{boxShadow: "rgba(0, 0, 0, 0.1) 3px 1px 7px 0px",
              ...
              <p className='text-4xl text-white font-bold'>16535 Kg <br />(In Total) </p>
          </div>

          <div className="bg-white rounded-xl p-4 text-white bg-gradient-to-br from-blue-500 to-blue-900 hover:from-blue-500 hover:to-blue-900 focus:ring-4 focus:ring-blue-300" style={{boxShadow: "rgba(0, 0, 0, 0.1) 3px 1px 7px 0px",
              backgroundImage: "url(../../public/sea3_bg.jpg)", backgroundSize: "cover", backgroundRepeat: "no-repeat"
            }}><Typography variant="h4" color="white" style={{fontSize: "1rem"}}>Most Common Species</Typography>
              <p className='  text-4xl text-white font-bold'>Mackeral (1950 kg)</p>
            </div>
      ...
      {/* Left Side: Map and Filters */}
        <div className="flex gap-4 w-full h-auto">
          <div className="w-[100vw] rounded-lg flex gap-6">
            ...
            <div className='relative w-2/3 bg-white rounded-2xl' style={{boxShadow: "rgba(0, 0, 0, 0.1) 3px 1px 7px 0px"}}>
              <div ref={mapContainer} className="h-full bg-gray-700 rounded-2xl p-3 py-6">
              ...
              <div className='absolute top-0 right-0 flex flex-col h-full gap-3 p-6' >
                <button className='p-3 w-full rounded-xl text-sm font-medium bg-blue-500 text-white mb-3' style={{zIndex: 9}} onClick={() => toggleMapMode('markers')}>
                  Markers
                </button>
                <button className=' p-3 w-full rounded-xl text-sm font-medium bg-green-500 text-white mb-3' style={{zIndex: 9}} onClick={() => toggleMapMode('heatmap')}>
                  Heatmap
                </button>
                <button className=' p-3 w-full rounded-xl text-sm font-medium bg-red-500 text-white' style={{zIndex: 9}} onClick={() => toggleMapMode('clusters')}>
                  Clusters
                </button>
              </div>
              ...
              <div className='w-1/2 rounded-2xl bg-white text-black' style={{boxShadow: "rgba(0, 0, 0, 0.1) 3px 1px 7px 0px"
