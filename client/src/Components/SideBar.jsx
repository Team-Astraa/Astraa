...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {!isOpen && (
        <button
          className="fixed top-6 left-4 z-50 p-2 text-white rounded-md lg:hidden"
      ...
      {/* Sidebar */}
      <div
        className={`fixed mt-20 top-0 left-0 h-full bg-[#0f123f] text-white flex flex-col items-center p-5 border-r-2 border-[#436ec6] transform transition-transform duration-300 z-30 ${
